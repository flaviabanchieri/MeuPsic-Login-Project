...
export class CardAtendimentosNowComponent implements OnInit {
  ...
  clientes = [
    ...
    },
    {
      ...
      check: false,
      imagem:
        'https://br.freepik.com/fotos-premium/pessoas-mulheres-negocios-e-conceito-de-retrato-rosto-de-jovem-sorridente-feliz_35825872.html',
    },
    {
      id: 3,
      nome: 'Pedro Almeida',
      ...
      check: false,
      imagem:
        'https://imasters.com.br/noticia/programador-usa-ia-para-criar-rostos-de-pessoas-que-nao-existem',
    },
    {
      id: 4,
      nome: 'Ana Pereira',
      ...
      check: false,
      imagem:
        'https://br.freepik.com/fotos-premium/foto-de-rosto-de-mulher-jovem-latina-feliz-com-fundo-de-expressao-de-sorriso-com-espaco-de-copia-retrato-de-rosto-de-pessoas-reais-etnicas-da-america-do-sul-boliviana_16104571.htm',
    },
    {
      id: 5,
    ...
    },
    {
      ...
      check: false,
      imagem:
        'https://super.abril.com.br/tecnologia/site-cria-rostos-perfeitamente-reais-usando-inteligencia-artificial',
    },
    {
      id: 7,
      nome: 'Carolina Lima',
      ...
      check: false,
      imagem:
        'https://super.abril.com.br/wp-content/uploads/2019/02/tecnologia-ia-rostos-04.png',
    },
    {
      id: 8,
    ...
    },
    {
      ...
      check: false,
      imagem:
        'https://super.abril.com.br/wp-content/uploads/2019/02/tecnologia-ia-rostos-08.png',
    },
    {
      id: 10,
      nome: 'Juliana Costa',
    ...
    },
    {
      ...
      check: false,
      imagem:
        'https://unsplash.com/pt-br/fotografias/uma-mulher-com-um-sorriso-no-rosto-lh9_ATRPKJQ',
    },
  ];

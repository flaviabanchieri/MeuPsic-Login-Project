...
var CardAtendimentosNowComponent = /** @class */ (function () {
    function CardAtendimentosNowComponent() {
        ...
        this.clientes = [
            { id: 1, nome: 'João Silva', data: "2023-08-08 15:01:01.000", presencial: true, check: false, imagem: 'https://br.freepik.com/fotos/pessoa-rosto' },
            { id: 2, nome: 'Maria Santos', data: "2023-07-18 19:01:01.000", presencial: true, check: false, imagem: 'https://br.freepik.com/fotos-premium/pessoas-mulheres-negocios-e-conceito-de-retrato-rosto-de-jovem-sorridente-feliz_35825872.html' },
            ...
            { id: 4, nome: 'Ana Pereira', data: "2023-08-08 15:15:01.000", presencial: true, check: false, imagem: 'https://br.freepik.com/fotos-premium/foto-de-rosto-de-mulher-jovem-latina-feliz-com-fundo-de-expressao-de-sorriso-com-espaco-de-copia-retrato-de-rosto-de-pessoas-reais-etnicas-da-america-do-sul-boliviana_16104571.htm' },
            ...
            { id: 6, nome: 'Lucas Martins', data: "2023-07-18 18:01:01.000", presencial: false, check: false, imagem: 'https://super.abril.com.br/tecnologia/site-cria-rostos-perfeitamente-reais-usando-inteligencia-artificial' },
            { id: 7, nome: 'Carolina Lima', data: "2023-08-08 16:01:01.000", presencial: true, check: false, imagem: 'https://super.abril.com.br/wp-content/uploads/2019/02/tecnologia-ia-rostos-04.png' },
    ...
    CardAtendimentosNowComponent.prototype.filtrarClientes = function () {
        ...
        this.primeirosClientesHoje = clientesHoje.filter(function (cliente) {
        ...
        this.haClientesDepois = this.clienteDepois.length > 0;
    };
